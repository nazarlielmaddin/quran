...
export const reciters: Reciter[] = [
  ...
  },
  {
    id: "badr-al-turki",
    name: "Badr Al Turki",
    nameAz: "Bədr Əl-Turki",
    arabicName: "بدر التركي",
    image: `${basePath}/images/reciters/badr-al-turki.jpg`,
    bio: "Imam of Masjid al-Haram since 2024, known for his melodious voice and precise Tajweed.",
    bioAz: "2024-cü ildən Məscidül-Həramın imamı, axıcı səsi və dəqiq tərtili ilə tanınır.",
    bioLong:
      "Sheikh Badr Al Turki (born 1984 in Buraidah) is a Saudi reciter and Imam of Masjid al-Haram since 2024. He memorized the Qur'an early, studied Sharia at Imam Mohammad Ibn Saud Islamic University, and holds an ijazah in the Ten Qira'at. Known for his melodious, heartfelt tilawah and precise Tajweed.",
    bioLongAz:
      "Şeyx Bədr Əl-Turki (1984, Burəydə) səudiyyəli qari və 2024-cü ildən Məscidül-Həramın imamıdır. Quranı erkən əzbərləyib, İmam Məhəmməd bin Səud İslam Universitetində təhsil alıb və Qiraətlərdə icazəsi var. Axıcı, hüzurlu tilavəti və dəqiq tərtili ilə tanınır.",
    hasTimestamps: true,
    origin: "Saudi Arabia",
    originAz: "Səudiyyə Ərəbistanı",
    provider: "quranicaudio",
    audioFolder: "badr_al_turki/mp3",
    timingSource: "qdc",
  },
  {
