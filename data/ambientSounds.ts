...
export const ambientSounds: AmbientSound[] = [
  ...
  { id: "cat", name: "Cat Purring", category: "cozy", gradient: ["#6b4f3a", "#170f0a"],
    audioUrl: "https://cdn.pixabay.com/audio/2022/03/15/audio_77048d6dc3.mp3",
    videoUrl: "https://cdn.pixabay.com/video/2023/03/28/156473-812592018_small.mp4",
    source: "Pixabay — cozy cat on the couch" },
