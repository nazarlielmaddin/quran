...
export const ambientSounds: AmbientSound[] = [
  ...
  { id: "cat", name: "Cute Cats", category: "cozy", gradient: ["#6b4f3a", "#170f0a"],
    audioUrl: "https://cdn.pixabay.com/audio/2022/03/15/audio_77048d6dc3.mp3",
    videoUrl: "https://cdn.pixabay.com/video/2022/10/12/134575-759723730_small.mp4",
    source: "Pixabay — cute cats on the window sill" },
