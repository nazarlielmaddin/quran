...
export const ambientSounds: AmbientSound[] = [
  ...
  { id: "cat", name: "Real Cat", nameAz: "Əsl Pişik", category: "cozy", categoryAz: "Rahat", gradient: ["#6b4f3a", "#170f0a"],
  ...
  { id: "room", name: "Soft Room Ambience", nameAz: "Yumşaq Otaq Ab-havası", category: "cozy", categoryAz: "Rahat", gradient: ["#4a3f3a", "#14100d"],
  ...
  // ── Focus ─────────────────────────────────────────────────────────────
  { id: "brownNoise", name: "Brown Noise", nameAz: "Qəhvəyi səs-küy", category: "focus", categoryAz: "Diqqət", gradient: ["#5a4a3a", "#140f0a"],
